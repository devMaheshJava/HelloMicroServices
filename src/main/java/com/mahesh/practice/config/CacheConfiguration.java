package com.mahesh.practice.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("HelloMicroServices");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("HelloMicroServices");
        ...
        config.getMapConfigs().put("com.mahesh.practice.domain.*", initializeDomainMapConfig(jHipsterProperties));
